...
namespace PPMImageEditor
{
  public partial class Form1 : Form
  {
    ...
    private void button1_Click(object sender, EventArgs e) //Grayscale button 
    {
      if (CurrentImage == null)  // sanity check: make sure we have an image to manipulate
        return;
      ...
      FSharpList<FSharpList<int>> newImageList;
      //
      newImageList = PPMImageLibrary.Grayscale(//This part is Modified for the method in ImageLibray.fs
        CurrentImage.Header.Width,
        CurrentImage.Header.Height, 
        CurrentImage.Header.Depth,
        CurrentImage.ImageListData
    ...
    private void button2_Click(object sender, EventArgs e)//FlipHorizontal
    {
      if (CurrentImage == null)  // sanity check: make sure we have an image to manipulate
        return;
    ...
    private void button3_Click(object sender, EventArgs e)//RotateRight90
    {
      if (CurrentImage == null)  // sanity check: make sure we have an image to manipulate
        return;
